...
cypher_generation_prompt = PromptTemplate(
    ...
    - IF ASKED WETHER A PROTEIN IS AN "ENZYME" CHECK THE PROTEIN TYPE NODE. OTHER PROTEIN TYPES ARE "GPCR", "RECEPTOR", "ION CHANNEL" and "OTHER"
    - Protein_Class CONTAINS INFO ON WETHER A PROTEIN IS KINASE, CYTOKINE, WHICH TYPE OF ENZYME ETC.
    ...
    - MAKE SURE IF YOU QUERY A PATHWAY NAME OR CLASS OR ONTOLOGY NAME IT IS CASE-INDEPENDANT
